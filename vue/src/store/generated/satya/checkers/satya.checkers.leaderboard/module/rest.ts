...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/satya/checkers/leaderboard/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryParamsResponse, RpcStatus>({
      path: `/satya/checkers/leaderboard/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/satya/checkers/leaderboard/player_info
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<LeaderboardQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/satya/checkers/leaderboard/player_info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
