...
func init() {
	proto.RegisterType((*MsgUpdateBoard)(nil), "satya.checkers.leaderboard.MsgUpdateBoard")
	proto.RegisterType((*MsgUpdateBoardResponse)(nil), "satya.checkers.leaderboard.MsgUpdateBoardResponse")
	proto.RegisterType((*MsgSendCandidate)(nil), "satya.checkers.leaderboard.MsgSendCandidate")
	proto.RegisterType((*MsgSendCandidateResponse)(nil), "satya.checkers.leaderboard.MsgSendCandidateResponse")
}
...
var fileDescriptor_abcbe4eb090e075c = []byte{
	...
	,
}
...
func (c *msgClient) UpdateBoard(ctx context.Context, in *MsgUpdateBoard, opts ...grpc.CallOption) (*MsgUpdateBoardResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/satya.checkers.leaderboard.Msg/UpdateBoard", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SendCandidate(ctx context.Context, in *MsgSendCandidate, opts ...grpc.CallOption) (*MsgSendCandidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/satya.checkers.leaderboard.Msg/SendCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateBoard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/satya.checkers.leaderboard.Msg/UpdateBoard",
	}
...
func _Msg_SendCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/satya.checkers.leaderboard.Msg/SendCandidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "satya.checkers.leaderboard.Msg",
