...
func TestGetAddressWrongBlack(t *testing.T) {
	...
	storedGame.Black = "cosmos1n67mm98uyz2qnzu7hrlgk68w7uvdyw62kzgtg1"
	black, err := storedGame.GetBlackAddress()
	require.Nil(t, black)
	require.EqualError(t, err, "black address is invalid: cosmos1n67mm98uyz2qnzu7hrlgk68w7uvdyw62kzgtg1: decoding bech32 failed: invalid separator index 44")
...
func TestGetAddressWrongRed(t *testing.T) {
	storedGame := GetStoredGame1()
	storedGame.Red = "cosmos10rsrdjqap9ynuhy5y05mzxffkh52gaqnsz7y10"
	red, err := storedGame.GetRedAddress()
	require.Nil(t, red)
	require.EqualError(t, err, "red address is invalid: cosmos10rsrdjqap9ynuhy5y05mzxffkh52gaqnsz7y10: decoding bech32 failed: invalid separator index 43")
	require.EqualError(t, storedGame.Validate(), err.Error())
}
